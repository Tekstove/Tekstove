...
abstract class LyricLanguage implements ActiveRecordInterface
{
    ...
    /**
     * Compares this with another <code>LyricLanguage</code> instance.  If
     * <code>obj</code> is an instance of <code>LyricLanguage</code>, delegates to
     * <code>equals(LyricLanguage)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|LyricLanguage The current object, for fluid interface
     */
    ...
    public function setLyricId($v)
    {
        ...
        if ($this->lyric_id !== $v) {
            $this->lyric_id = $v;
            $this->modifiedColumns[LyricLanguageTableMap::COL_LYRIC_ID] = true;
        }
    ...
    public function setLanguageId($v)
    {
        ...
        if ($this->language_id !== $v) {
            $this->language_id = $v;
            $this->modifiedColumns[LyricLanguageTableMap::COL_LANGUAGE_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : LyricLanguageTableMap::translateFieldName('LyricId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->lyric_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : LyricLanguageTableMap::translateFieldName('LanguageId', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildLyricLanguageQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see LyricLanguage::setDeleted()
     * @see LyricLanguage::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildLyricLanguageQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                LyricLanguageTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    {
        $pos = LyricLanguageTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['LyricLanguage'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['LyricLanguage'][$this->hashCode()] = true;
        $keys = LyricLanguageTableMap::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LyricLanguageTableMap::COL_LYRIC_ID)) {
            $criteria->add(LyricLanguageTableMap::COL_LYRIC_ID, $this->lyric_id);
        }
        if ($this->isColumnModified(LyricLanguageTableMap::COL_LANGUAGE_ID)) {
            $criteria->add(LyricLanguageTableMap::COL_LANGUAGE_ID, $this->language_id);
        }
    ...
    {
        $criteria = ChildLyricLanguageQuery::create();
        $criteria->add(LyricLanguageTableMap::COL_LYRIC_ID, $this->lyric_id);
        $criteria->add(LyricLanguageTableMap::COL_LANGUAGE_ID, $this->language_id);
    ...
    public function hashCode()
    {
        $validPk = null !== $this->getLyricId() &&
            null !== $this->getLanguageId();

        $validPrimaryKeyFKs = 2;
        $primaryKeyFKs = [];

        //relation lyric_language_fk_caf60d to table lyric
        ...
        //relation lyric_language_fk_5d937a to table language
        if ($this->aLanguage && $hash = spl_object_hash($this->aLanguage)) {
            $primaryKeyFKs[] = $hash;
        } else {
            $validPrimaryKeyFKs = false;
        }
    ...
    {
        return (null === $this->getLyricId()) && (null === $this->getLanguageId());
    }
    ...
    public function getLyric(ConnectionInterface $con = null)
    {
        if ($this->aLyric === null && ($this->lyric_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aLyric->addLyricLanguages($this);
             */
        }
    ...
    public function getLanguage(ConnectionInterface $con = null)
    {
        if ($this->aLanguage === null && ($this->language_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aLanguage->addLyricLanguages($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(LyricLanguageTableMap::DEFAULT_STRING_FORMAT);
    }
