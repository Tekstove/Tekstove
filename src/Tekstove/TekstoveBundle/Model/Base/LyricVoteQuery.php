 ...
 *
 * @method     \Tekstove\TekstoveBundle\Model\UserQuery|\Tekstove\TekstoveBundle\Model\LyricQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class LyricVoteQuery extends ModelCriteria
{
    ...
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = LyricVoteTableMap::getInstanceFromPool((string) $key))) && !$this->formatter) {
    ...
    protected function findPkSimple($key, ConnectionInterface $con)
    {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            ...
            $obj->hydrate($row);
            LyricVoteTableMap::addInstanceToPool($obj, (string) $key);
        }
        $stmt->closeCursor();
