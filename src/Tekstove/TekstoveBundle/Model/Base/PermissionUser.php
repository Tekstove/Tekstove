...
abstract class PermissionUser implements ActiveRecordInterface
{
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : PermissionUserTableMap::translateFieldName('PermissionId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->permission_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : PermissionUserTableMap::translateFieldName('UserId', TableMap::TYPE_PHPNAME, $indexType)];
