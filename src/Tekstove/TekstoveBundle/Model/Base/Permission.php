...
abstract class Permission implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Tekstove\\TekstoveBundle\\Model\\Map\\PermissionTableMap';
    ...
    /**
     * Initializes internal state of Tekstove\TekstoveBundle\Model\Base\Permission object.
     */
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->permissionGroupPermissionsScheduledForDeletion !== null) {
                if (!$this->permissionGroupPermissionsScheduledForDeletion->isEmpty()) {
                    \Tekstove\TekstoveBundle\Model\PermissionGroupPermissionQuery::create()
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Tekstove\TekstoveBundle\Model\Permission
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Tekstove\TekstoveBundle\Model\Permission The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Tekstove\TekstoveBundle\Model\Permission (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Tekstove\TekstoveBundle\Model\Permission Clone of current object.
     * @throws PropelException
     */
    ...
    public function setPermissionUsers(Collection $permissionUsers, ConnectionInterface $con = null)
    {
        ...
        foreach ($permissionUsersToDelete as $permissionUserRemoved) {
            $permissionUserRemoved->setPermission(null);
        }
    ...
    protected function doAddPermissionUser(ChildPermissionUser $permissionUser)
    {
        ...
        $permissionUser->setPermission($this);
    }
    ...
    public function removePermissionUser(ChildPermissionUser $permissionUser)
    {
        if ($this->getPermissionUsers()->contains($permissionUser)) {
            ...
            $permissionUser->setPermission(null);
        }
     ...
     * @return ObjectCollection|ChildPermissionUser[] List of ChildPermissionUser objects
     */
    public function getPermissionUsersJoinUser(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildPermissionUserQuery::create(null, $criteria);
    ...
    public function initPermissionGroupPermissions($overrideExisting = true)
    {
        ...
        $this->collPermissionGroupPermissions->setModel('\Tekstove\TekstoveBundle\Model\PermissionGroupPermission');
    }
    ...
    public function setPermissionGroupPermissions(Collection $permissionGroupPermissions, ConnectionInterface $con = null)
    {
        ...
        foreach ($permissionGroupPermissionsToDelete as $permissionGroupPermissionRemoved) {
            $permissionGroupPermissionRemoved->setPermission(null);
        }
    ...
    protected function doAddPermissionGroupPermission(ChildPermissionGroupPermission $permissionGroupPermission)
    {
        ...
        $permissionGroupPermission->setPermission($this);
    }
    ...
    public function removePermissionGroupPermission(ChildPermissionGroupPermission $permissionGroupPermission)
    {
        if ($this->getPermissionGroupPermissions()->contains($permissionGroupPermission)) {
            ...
            $permissionGroupPermission->setPermission(null);
        }
     ...
     * @return ObjectCollection|ChildPermissionGroupPermission[] List of ChildPermissionGroupPermission objects
     */
    public function getPermissionGroupPermissionsJoinPermissionGroup(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildPermissionGroupPermissionQuery::create(null, $criteria);
