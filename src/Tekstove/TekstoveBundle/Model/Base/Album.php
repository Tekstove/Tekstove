...
abstract class Album implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Tekstove\\TekstoveBundle\\Model\\Map\\AlbumTableMap';
    ...
    /**
     * Initializes internal state of Tekstove\TekstoveBundle\Model\Base\Album object.
     */
     ...
     * @return $this|\Tekstove\TekstoveBundle\Model\Album The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Tekstove\\TekstoveBundle\\Model\\Album'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Tekstove\TekstoveBundle\Model\Album
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Tekstove\TekstoveBundle\Model\Album The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Tekstove\TekstoveBundle\Model\Album (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Tekstove\TekstoveBundle\Model\Album Clone of current object.
     * @throws PropelException
     */
