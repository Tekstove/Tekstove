...
abstract class LyricVote implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Tekstove\\TekstoveBundle\\Model\\Map\\LyricVoteTableMap';
    ...
    /**
     * Initializes internal state of Tekstove\TekstoveBundle\Model\Base\LyricVote object.
     */
     ...
     * @return $this|\Tekstove\TekstoveBundle\Model\LyricVote The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Tekstove\\TekstoveBundle\\Model\\LyricVote'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Tekstove\TekstoveBundle\Model\LyricVote
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Tekstove\TekstoveBundle\Model\LyricVote The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Tekstove\TekstoveBundle\Model\LyricVote (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Tekstove\TekstoveBundle\Model\LyricVote Clone of current object.
     * @throws PropelException
     */
