...
abstract class PermissionGroup implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Tekstove\\TekstoveBundle\\Model\\Acl\\Map\\PermissionGroupTableMap';
    ...
    /**
     * Initializes internal state of Tekstove\TekstoveBundle\Model\Acl\Base\PermissionGroup object.
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Tekstove\\TekstoveBundle\\Model\\Acl\\PermissionGroup'), 0, $e);
        }
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Tekstove\TekstoveBundle\Model\Acl\PermissionGroup (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Tekstove\TekstoveBundle\Model\Acl\PermissionGroup Clone of current object.
     * @throws PropelException
     */
