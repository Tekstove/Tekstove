...
class LyricTranslationTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src..Tekstove.TekstoveBundle.Model.Lyric.Map.LyricTranslationTableMap';
     ...
     */
    const OM_CLASS = '\\Tekstove\\TekstoveBundle\\Model\\Lyric\\LyricTranslation';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src..Tekstove.TekstoveBundle.Model.Lyric.LyricTranslation';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Tekstove\\TekstoveBundle\\Model\\Lyric\\LyricTranslation');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Tekstove\TekstoveBundle\Model\Lyric\LyricTranslation) { // it's a model object
