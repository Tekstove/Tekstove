...
use Tekstove\TekstoveBundle\Model\Lyric\LyricTranslation as ChildLyricTranslation;
 ...
 *
 * @method     \Tekstove\TekstoveBundle\Model\LyricQuery|\Tekstove\TekstoveBundle\Model\UserQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class LyricTranslationQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Tekstove\TekstoveBundle\Model\Lyric\Base\LyricTranslationQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Tekstove\\TekstoveBundle\\Model\\Lyric\\LyricTranslation', $modelAlias = null)
    {
    ...
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = LyricTranslationTableMap::getInstanceFromPool((string) $key))) && !$this->formatter) {
    ...
    protected function findPkSimple($key, ConnectionInterface $con)
    {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            ...
            $obj->hydrate($row);
            LyricTranslationTableMap::addInstanceToPool($obj, (string) $key);
        }
        $stmt->closeCursor();
