...
use Tekstove\TekstoveBundle\Model\Lyric\LyricTranslationQuery as ChildLyricTranslationQuery;
use Tekstove\TekstoveBundle\Model\Lyric\Map\LyricTranslationTableMap;
...
abstract class LyricTranslation implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Tekstove\\TekstoveBundle\\Model\\Lyric\\Map\\LyricTranslationTableMap';
    ...
    /**
     * Initializes internal state of Tekstove\TekstoveBundle\Model\Lyric\Base\LyricTranslation object.
     */
     ...
     * @return $this|\Tekstove\TekstoveBundle\Model\Lyric\LyricTranslation The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Tekstove\\TekstoveBundle\\Model\\Lyric\\LyricTranslation'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Tekstove\TekstoveBundle\Model\Lyric\LyricTranslation
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Tekstove\TekstoveBundle\Model\Lyric\LyricTranslation The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Tekstove\TekstoveBundle\Model\Lyric\LyricTranslation (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Tekstove\TekstoveBundle\Model\Lyric\LyricTranslation Clone of current object.
     * @throws PropelException
     */
