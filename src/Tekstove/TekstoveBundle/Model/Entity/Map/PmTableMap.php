...
use Tekstove\TekstoveBundle\Model\Entity\Pm;
use Tekstove\TekstoveBundle\Model\Entity\PmQuery;
...
class PmTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Tekstove.TekstoveBundle.Model.Entity.Map.PmTableMap';
     ...
     */
    const OM_CLASS = '\\Tekstove\\TekstoveBundle\\Model\\Entity\\Pm';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Tekstove.TekstoveBundle.Model.Entity.Pm';
    ...
    /**
     * the column name for the otnosno field
     */
    const COL_OTNOSNO = 'pm.otnosno';

    /**
     * the column name for the data field
     */
    const COL_DATA = 'pm.data';

    /**
     * the column name for the procheteno field
     */
    const COL_PROCHETENO = 'pm.procheteno';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Za', 'Ot', 'Text', 'Otnosno', 'Data', 'Procheteno', 'Ip', ),
        self::TYPE_CAMELNAME     => array('id', 'za', 'ot', 'text', 'otnosno', 'data', 'procheteno', 'ip', ),
        self::TYPE_COLNAME       => array(PmTableMap::COL_ID, PmTableMap::COL_ZA, PmTableMap::COL_OT, PmTableMap::COL_TEXT, PmTableMap::COL_OTNOSNO, PmTableMap::COL_DATA, PmTableMap::COL_PROCHETENO, PmTableMap::COL_IP, ),
        self::TYPE_FIELDNAME     => array('id', 'za', 'ot', 'text', 'otnosno', 'data', 'procheteno', 'ip', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Za' => 1, 'Ot' => 2, 'Text' => 3, 'Otnosno' => 4, 'Data' => 5, 'Procheteno' => 6, 'Ip' => 7, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'za' => 1, 'ot' => 2, 'text' => 3, 'otnosno' => 4, 'data' => 5, 'procheteno' => 6, 'ip' => 7, ),
        self::TYPE_COLNAME       => array(PmTableMap::COL_ID => 0, PmTableMap::COL_ZA => 1, PmTableMap::COL_OT => 2, PmTableMap::COL_TEXT => 3, PmTableMap::COL_OTNOSNO => 4, PmTableMap::COL_DATA => 5, PmTableMap::COL_PROCHETENO => 6, PmTableMap::COL_IP => 7, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'za' => 1, 'ot' => 2, 'text' => 3, 'otnosno' => 4, 'data' => 5, 'procheteno' => 6, 'ip' => 7, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Tekstove\\TekstoveBundle\\Model\\Entity\\Pm');
        ...
        $this->addColumn('otnosno', 'Otnosno', 'VARCHAR', true, 150, null);
        $this->addColumn('data', 'Data', 'TIMESTAMP', true, null, 'CURRENT_TIMESTAMP');
        $this->addColumn('procheteno', 'Procheteno', 'BOOLEAN', true, 1, null);
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PmTableMap::COL_ZA);
            $criteria->addSelectColumn(PmTableMap::COL_OT);
            $criteria->addSelectColumn(PmTableMap::COL_TEXT);
            $criteria->addSelectColumn(PmTableMap::COL_OTNOSNO);
            $criteria->addSelectColumn(PmTableMap::COL_DATA);
            $criteria->addSelectColumn(PmTableMap::COL_PROCHETENO);
            $criteria->addSelectColumn(PmTableMap::COL_IP);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.za');
            $criteria->addSelectColumn($alias . '.ot');
            $criteria->addSelectColumn($alias . '.text');
            $criteria->addSelectColumn($alias . '.otnosno');
            $criteria->addSelectColumn($alias . '.data');
            $criteria->addSelectColumn($alias . '.procheteno');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Tekstove\TekstoveBundle\Model\Entity\Pm) { // it's a model object
