...
use Tekstove\TekstoveBundle\Model\Entity\Log;
use Tekstove\TekstoveBundle\Model\Entity\LogQuery;
...
class LogTableMap extends TableMap
{
     ...
     */
    const OM_CLASS = '\\Tekstove\\TekstoveBundle\\Model\\Entity\\Log';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(LogTableMap::COL_ID, LogTableMap::COL_TEXT, LogTableMap::COL_DATA, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(LogTableMap::COL_ID => 0, LogTableMap::COL_TEXT => 1, LogTableMap::COL_DATA => 2, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(LogTableMap::COL_TEXT);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Tekstove\TekstoveBundle\Model\Entity\Log) { // it's a model object
