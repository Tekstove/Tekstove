...
class LyricTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->addColumn('zaglavie_sakrateno', 'ZaglavieSakrateno', 'VARCHAR', true, 280, null);
