...
class LyricTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('language', 'language', 'TINYINT', 'languages', 'id', true, 1, null);
