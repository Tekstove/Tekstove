...
class LyricTableMap extends TableMap
{
     ...
     */
    const COL_LANGUAGE = 'lyric.language';
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('language', 'languageId', 'TINYINT', 'languages', 'id', false, 1, null);
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(LyricTableMap::COL_LANGUAGE);
