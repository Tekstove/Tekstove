...
class PermissionGroupsTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Tekstove.TekstoveBundle.Model.Entity.Map.PermissionGroupsTableMap';
     ...
     */
    const CLASS_DEFAULT = 'Tekstove.TekstoveBundle.Model.Entity.PermissionGroups';
