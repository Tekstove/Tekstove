...
namespace Tekstove\TekstoveBundle\Model\Entity\Lyric\Map;
...
class VotesTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Tekstove.TekstoveBundle.Model.Entity.Lyric.Map.VotesTableMap';
     ...
     */
    const CLASS_DEFAULT = 'Tekstove.TekstoveBundle.Model.Entity.Lyric.Votes';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(VotesTableMap::COL_ZA, VotesTableMap::COL_OT, VotesTableMap::COL_ID, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(VotesTableMap::COL_ZA => 0, VotesTableMap::COL_OT => 1, VotesTableMap::COL_ID => 2, ),
    ...
    public function initialize()
    {
        ...
        $this->setPackage('Tekstove.TekstoveBundle.Model.Entity.Lyric');
  ...
  array (
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(VotesTableMap::COL_ZA);
            $criteria->addSelectColumn(VotesTableMap::COL_OT);
