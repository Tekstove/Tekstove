...
abstract class Log implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Tekstove\\TekstoveBundle\\Model\\Entity\\Map\\LogTableMap';
    ...
    /**
     * Initializes internal state of Tekstove\TekstoveBundle\Model\Entity\Base\Log object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\Tekstove\TekstoveBundle\Model\Entity\Log The current object (for fluent API support)
     */
    ...
    public function setText($v)
    {
        ...
        if ($this->text !== $v) {
            $this->text = $v;
            $this->modifiedColumns[LogTableMap::COL_TEXT] = true;
        }
    ...
    public function setData($v)
    {
        ...
        if ($this->data !== null || $dt !== null) {
            if ($this->data === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->data->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[LogTableMap::COL_DATA] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : LogTableMap::translateFieldName('Text', TableMap::TYPE_PHPNAME, $indexType)];
            $this->text = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : LogTableMap::translateFieldName('Data', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Tekstove\\TekstoveBundle\\Model\\Entity\\Log'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(LogTableMap::COL_TEXT)) {
            $modifiedColumns[':p' . $index++]  = 'text';
        }
        if ($this->isColumnModified(LogTableMap::COL_DATA)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Tekstove\TekstoveBundle\Model\Entity\Log
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Tekstove\TekstoveBundle\Model\Entity\Log The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LogTableMap::COL_TEXT)) {
            $criteria->add(LogTableMap::COL_TEXT, $this->text);
        }
        if ($this->isColumnModified(LogTableMap::COL_DATA)) {
            $criteria->add(LogTableMap::COL_DATA, $this->data);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Tekstove\TekstoveBundle\Model\Entity\Log (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Tekstove\TekstoveBundle\Model\Entity\Log Clone of current object.
     * @throws PropelException
     */
