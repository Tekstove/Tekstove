 ...
 *
 *
 * @method     ChildLanguagesQuery orderById($order = Criteria::ASC) Order by the id column
 * @method     ChildLanguagesQuery orderByName($order = Criteria::ASC) Order by the name column
 *
 * @method     ChildLanguagesQuery groupById() Group by the id column
 ...
 *
 * @method     ChildLanguages findOneById(int $id) Return the first ChildLanguages filtered by the id column
 ...
 *
 * @method     ChildLanguages requireOneById(int $id) Return the first ChildLanguages filtered by the id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildLanguages requireOneByName(string $name) Return the first ChildLanguages filtered by the name column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildLanguages[]|ObjectCollection findById(int $id) Return ChildLanguages objects filtered by the id column
...
abstract class LanguagesQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Tekstove\TekstoveBundle\Model\Entity\Base\LanguagesQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Tekstove\\TekstoveBundle\\Model\\Entity\\Languages', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, name FROM languages WHERE id = :p0';
        try {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(LanguagesTableMap::COL_ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(LanguagesTableMap::COL_ID, $keys, Criteria::IN);
    }
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(LanguagesTableMap::COL_ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(LanguagesTableMap::COL_ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(LanguagesTableMap::COL_ID, $id, $comparison);
    }
    ...
    {
        if ($languages) {
            $this->addUsingAlias(LanguagesTableMap::COL_ID, $languages->getId(), Criteria::NOT_EQUAL);
        }
