...
abstract class Today implements ActiveRecordInterface
{
    ...
    public function setArtistId($v)
    {
        ...
        if ($this->aArtists !== null && $this->aArtists->getId() !== $v) {
            $this->aArtists = null;
        }
    ...
    {
        if ($this->aArtists !== null && $this->artist_id !== $this->aArtists->getId()) {
            $this->aArtists = null;
        }
    } // ensureConsistency
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aArtists !== null) {
                if ($this->aArtists->isModified() || $this->aArtists->isNew()) {
                    $affectedRows += $this->aArtists->save($con);
                }
                $this->setArtists($this->aArtists);
            }
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aArtists) {
                ...
                $result[$key] = $this->aArtists->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    /**
     * Declares an association between this object and a ChildArtists object.
     *
     * @param  ChildArtists $v
     * @return $this|\Tekstove\TekstoveBundle\Model\Entity\Today The current object (for fluent API support)
     * @throws PropelException
     */
    public function setArtists(ChildArtists $v = null)
    {
        if ($v === null) {
        ...
        // If this object has already been added to the ChildArtists object, it will not be re-added.
        if ($v !== null) {
            $v->addToday($this);
        }
    ...
    /**
     * Get the associated ChildArtists object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildArtists The associated ChildArtists object.
     * @throws PropelException
     */
    public function getArtists(ConnectionInterface $con = null)
    {
        if ($this->aArtists === null && ($this->artist_id !== null)) {
            $this->aArtists = ChildArtistsQuery::create()->findPk($this->artist_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aArtists->addTodays($this);
             */
        }
    ...
    {
        if (null !== $this->aArtists) {
            $this->aArtists->removeToday($this);
        }
        $this->id = null;
        $this->date = null;
        $this->artist_id = null;
