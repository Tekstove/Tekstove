...
*/
abstract class Artists implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Tekstove\\TekstoveBundle\\Model\\Entity\\Map\\ArtistsTableMap';
    ...
    /**
     * Initializes internal state of Tekstove\TekstoveBundle\Model\Entity\Base\Artists object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>Artists</code> instance.  If
     * <code>obj</code> is an instance of <code>Artists</code>, delegates to
     * <code>equals(Artists)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Artists The current object, for fluid interface
     */
     ...
     * @return $this|\Tekstove\TekstoveBundle\Model\Entity\Artists The current object (for fluent API support)
     */
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[ArtistsTableMap::COL_NAME] = true;
        }
    ...
    public function setNameAlternatives($v)
    {
        ...
        if ($this->name_alternatives !== $v) {
            ...
            $this->modifiedColumns[ArtistsTableMap::COL_NAME_ALTERNATIVES] = true;
        }
    ...
    public function setAddedby($v)
    {
        ...
        if ($this->addedby !== $v) {
            $this->addedby = $v;
            $this->modifiedColumns[ArtistsTableMap::COL_ADDEDBY] = true;
        }
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[ArtistsTableMap::COL_ID] = true;
        }
    ...
    public function setRedirectToArtistId($v)
    {
        ...
        if ($this->redirect_to_artist_id !== $v) {
            ...
            $this->modifiedColumns[ArtistsTableMap::COL_REDIRECT_TO_ARTIST_ID] = true;
        }
    ...
    public function setForbidden($v)
    {
        ...
        if ($this->forbidden !== $v) {
            $this->forbidden = $v;
            $this->modifiedColumns[ArtistsTableMap::COL_FORBIDDEN] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ArtistsTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ArtistsTableMap::translateFieldName('NameAlternatives', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name_alternatives = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ArtistsTableMap::translateFieldName('Addedby', TableMap::TYPE_PHPNAME, $indexType)];
            $this->addedby = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ArtistsTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ArtistsTableMap::translateFieldName('RedirectToArtistId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->redirect_to_artist_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : ArtistsTableMap::translateFieldName('Forbidden', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 6; // 6 = ArtistsTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Tekstove\\TekstoveBundle\\Model\\Entity\\Artists'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildArtistsQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Artists::setDeleted()
     * @see Artists::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildArtistsQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ArtistsTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ArtistsTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(ArtistsTableMap::COL_NAME_ALTERNATIVES)) {
            $modifiedColumns[':p' . $index++]  = 'name_alternatives';
        }
        if ($this->isColumnModified(ArtistsTableMap::COL_ADDEDBY)) {
            $modifiedColumns[':p' . $index++]  = 'addedby';
        }
        if ($this->isColumnModified(ArtistsTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(ArtistsTableMap::COL_REDIRECT_TO_ARTIST_ID)) {
            $modifiedColumns[':p' . $index++]  = 'redirect_to_artist_id';
        }
        if ($this->isColumnModified(ArtistsTableMap::COL_FORBIDDEN)) {
    ...
    {
        $pos = ArtistsTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Artists'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Artists'][$this->hashCode()] = true;
        $keys = ArtistsTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getName(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Tekstove\TekstoveBundle\Model\Entity\Artists
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Tekstove\TekstoveBundle\Model\Entity\Artists The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ArtistsTableMap::COL_NAME)) {
            $criteria->add(ArtistsTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(ArtistsTableMap::COL_NAME_ALTERNATIVES)) {
            $criteria->add(ArtistsTableMap::COL_NAME_ALTERNATIVES, $this->name_alternatives);
        }
        if ($this->isColumnModified(ArtistsTableMap::COL_ADDEDBY)) {
            $criteria->add(ArtistsTableMap::COL_ADDEDBY, $this->addedby);
        }
        if ($this->isColumnModified(ArtistsTableMap::COL_ID)) {
            $criteria->add(ArtistsTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(ArtistsTableMap::COL_REDIRECT_TO_ARTIST_ID)) {
            $criteria->add(ArtistsTableMap::COL_REDIRECT_TO_ARTIST_ID, $this->redirect_to_artist_id);
        }
        if ($this->isColumnModified(ArtistsTableMap::COL_FORBIDDEN)) {
            $criteria->add(ArtistsTableMap::COL_FORBIDDEN, $this->forbidden);
        }
    ...
    {
        $criteria = ChildArtistsQuery::create();
        $criteria->add(ArtistsTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Tekstove\TekstoveBundle\Model\Entity\Artists (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Tekstove\TekstoveBundle\Model\Entity\Artists Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildArtists is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildArtists The current object (for fluent API support)
     */
    ...
    {
        return (string) $this->exportTo(ArtistsTableMap::DEFAULT_STRING_FORMAT);
    }
