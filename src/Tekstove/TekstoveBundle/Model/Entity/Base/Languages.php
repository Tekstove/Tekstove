...
use Tekstove\TekstoveBundle\Model\Entity\Map\LanguagesTableMap;
...
abstract class Languages implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Tekstove\\TekstoveBundle\\Model\\Entity\\Map\\LanguagesTableMap';
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[LanguagesTableMap::COL_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[LanguagesTableMap::COL_NAME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : LanguagesTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : LanguagesTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Tekstove\\TekstoveBundle\\Model\\Entity\\Languages'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[LanguagesTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . LanguagesTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(LanguagesTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(LanguagesTableMap::COL_NAME)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Tekstove\TekstoveBundle\Model\Entity\Languages
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Tekstove\TekstoveBundle\Model\Entity\Languages The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LanguagesTableMap::COL_ID)) {
            $criteria->add(LanguagesTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(LanguagesTableMap::COL_NAME)) {
            $criteria->add(LanguagesTableMap::COL_NAME, $this->name);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Tekstove\TekstoveBundle\Model\Entity\Languages (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Tekstove\TekstoveBundle\Model\Entity\Languages Clone of current object.
     * @throws PropelException
     */
    ...
    public function initlanguages($overrideExisting = true)
    {
        ...
        $this->colllanguages->setModel('\Tekstove\TekstoveBundle\Model\Entity\Lyric');
    }
    ...
    public function getlanguages(Criteria $criteria = null, ConnectionInterface $con = null)
    {
        ...
        if (null === $this->colllanguages || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->colllanguages) {
                ...
                $colllanguages = ChildLyricQuery::create(null, $criteria)
    ...
    {
        /** @var ChildLyric[] $languagesToDelete */
        ...
        foreach ($languagesToDelete as $languageRemoved) {
            $languageRemoved->setLanguages(null);
        }
     ...
     * @return $this|\Tekstove\TekstoveBundle\Model\Entity\Languages The current object (for fluent API support)
     */
    public function addlanguage(ChildLyric $l)
    {
        if ($this->colllanguages === null) {
            $this->initlanguages();
            $this->colllanguagesPartial = true;
    ...
    /**
     * @param ChildLyric $language The ChildLyric object to add.
     */
    protected function doAddlanguage(ChildLyric $language)
    {
        $this->colllanguages[]= $language;
        $language->setLanguages($this);
    }

    /**
     * @param  ChildLyric $language The ChildLyric object to remove.
     * @return $this|ChildLanguages The current object (for fluent API support)
     */
    public function removelanguage(ChildLyric $language)
    {
     ...
     * @return ObjectCollection|ChildLyric[] List of ChildLyric objects
     */
    public function getlanguagesJoinUsers(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildLyricQuery::create(null, $criteria);
